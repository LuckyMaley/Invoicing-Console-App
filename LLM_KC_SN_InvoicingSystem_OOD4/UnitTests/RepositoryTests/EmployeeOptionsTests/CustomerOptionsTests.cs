...
namespace UnitTests.RepositoryTests.EmployeeOptionsTests
{
    ...
    {
        Mock<CustomerRepository> _mockCustomersrepository;
        ...
        public void SetUp()
        {
            _mockCustomersrepository = new Mock<CustomerRepository>();
        ...
        [Test]
        public void _31Test_FindCustomerByID_ExpectedThrowsException_WhenReadRowByIDThrowsNullException()
        {
            // Arrange
            int customerId = 1;
            ...
            // Act
             _mockCustomersrepository.Setup(repo => repo.CheckIfIdExists(customerId)).Returns(true);
            _mockCustomersrepository.Setup(repo => repo.ReadRowByID(customerId)).Throws(new NullReferenceException());
            
            // Assert
            Assert.Throws<NullReferenceException>(() => _customerOptions.FindCustomerByID(customerId));
        }

        [Test]
        public void _32Test_FindCustomerByID_ExpectedDoesNotThrowException_WhenCheckIfIdExistsIsFalse()
        {
            // Arrange
            int customerId = 12;
            ...
            // Assert
            Assert.DoesNotThrow(() => _customerOptions.FindCustomerByID(customerId));
        }
    }
}
